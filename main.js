...
var author$project$Main$init = function (currentUser) {
	return _Utils_Tuple2(currentUser, elm$core$Platform$Cmd$none);
};
var author$project$Main$UserChanged = function (a) {
	return {$: 'UserChanged', a: a};
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Main$userChanged = _Platform_incomingPort('userChanged', elm$json$Json$Decode$value);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$userChanged(author$project$Main$UserChanged)
			]));
};
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$Main$toggleSignIn = _Platform_outgoingPort('toggleSignIn', elm$core$Basics$identity);
...
var author$project$Main$unwrapUser = function (value) {
	var userResult = A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$string, value);
	return elm$core$Result$toMaybe(userResult);
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UserChanged':
				var userValue = msg.a;
				var user = author$project$Main$unwrapUser(userValue);
				return _Utils_Tuple2(user, elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					model,
					author$project$Main$toggleSignIn(elm$json$Json$Encode$null));
		}
	});
var author$project$Main$ToggleSignIn = {$: 'ToggleSignIn'};
		...
		if (model.$ === 'Nothing') {
			return A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$id('quickstart-sign-in'),
						elm$html$Html$Attributes$class('button is-info'),
						elm$html$Html$Events$onClick(author$project$Main$ToggleSignIn)
					]),
				_List_fromArray(
					[
			...
			if (model.a === 'isSigningIn') {
				return A2(
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$id('quickstart-sign-in'),
							elm$html$Html$Attributes$class('button is-info is-loading')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Sign in with Google')
				...
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Sign out ' + user)
						]));
			}
		}
	}();
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$oneOf(
		_List_fromArray(
			...
			])))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"UserChanged":["Json.Decode.Value"],"ToggleSignIn":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));